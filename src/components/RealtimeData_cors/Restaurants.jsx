...
import useGetRestaurants from "../../Foodie/utils/useGetRestaurants.js";
import { useDispatch, useSelector } from "react-redux";
import { setLongitude, setLatitude } from "../../Redux/features/coordsSlice.js";
import { coordsFetch } from "../../Redux/features/coordsSlice";
import { GiHotMeal } from "react-icons/gi";
import { BsFillSuitHeartFill } from "react-icons/bs";
import { MdLocationPin } from "react-icons/md";
import {RestaurantsShimmer,RestaurantCard,Search} from "@components";
...
const Restaurants = () => {
  ...
  return (
    <div className="main-scroll-restaurants">
      ...
      items-center gap-2 md:px-5 md:pt-3 ">
        <Search
