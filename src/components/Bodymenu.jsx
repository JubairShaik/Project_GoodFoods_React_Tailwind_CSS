      ...
      <div className="bg-primary text-white font-poppins     ">
        ...
        <div className="flex    p-6 sm:p-16 space-x-6 justify-center mt- bg-gray-900 text-gray-100">
         ...
         "
              ...
              <button className="bg-orange-500  text-[1.4rem] rounded-md text-white  sm:py-[.9rem] py-[.6rem] sm:px-[5rem]  w-[100%]   font-medium text-center font-poppins">
                Order Now
              </button>
            </div>
          </div>
                ...
                <div className="flex  bg-slate-800 p-2 rounded-md sm:w-[43rem] space-x-3">
                  ...
                  <div className="flex sm:flex-row  sm:gap-[4rem]  items-center   gap-2 flex-col flex-1 ">
                    <div className="flex flex-col  w-full   ">
                      <h1 className="sm:font-semibold  sm:text-[20px]   text-[19px] overflow-hidden overflow-ellipsis">
                        {item.name}
                      </h1>
                      <p className="text-green-400 sm:text-[1.6rem] text-[1rem]  font-semibold">
                        ₹ {item.price / 100}
                      </p>
                    </div>
