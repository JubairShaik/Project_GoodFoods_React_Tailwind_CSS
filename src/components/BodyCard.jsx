  ...
  return (
    <div className="sm:w-[22rem] font-poppins w-[20rem] h-[22.4rem] transition-all cursor-pointer rounded-2xl p-1 sm:p-3 hover:shadow-orange-500 text-white  shadow-sm">
      ...
      <div className="flex items-center mt-2 mx-1 justify-between">
        <h2 className="font-poppins mt-1 sm:font-medium text-[1.3rem]">{name}</h2>
      ...
      <h4 className="text-green-500 font-poppins font-medium text-[1.5rem]">{costForTwoString}</h4>
      <p className="w-[100%] h-[1px] bg-slate-400 mb-2"></p>
     <div className="flex justify-between mx-2 ">
     <h3 className="cuisines text-[15px] text-gray-500">{firstTwoCuisines}</h3>
