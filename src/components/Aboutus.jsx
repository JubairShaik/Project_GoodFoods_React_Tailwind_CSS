      ...
      <div className=" bg-primary  px-[2rem] h-full pb-[10rem] sm:px-[6rem]   ">
        <div className="">
          ...
          <div className="flex flex-wrap-reverse  mt-[1rem]  justify-around items-center">
            <h2 className="textorang font-bold text-[2rem] sm:text-[6rem] sm:leading-[100px] leading-[50px] font-poppins  z-10">
              Know <br className=" sm:flex hidden" /> About Us
            </h2>
          ...
          <h2 className="textorang font-bold text-[2rem] sm:text-[3.4rem] font-poppins  z-10">
            Know more....
          </h2>
          ...
          <Section
            ...
            desc={
              "We understand that dining out is not just about the food, it's about the entire experience. That's why we have created a warm and welcoming ambiance that makes our guests feel right at home. Our staff is friendly and always ready to assist you in making your dining experience a memorable one. We are committed to using only the highest quality ingredients in our dishes, and we work with local farmers and suppliers to ensure that our food is always fresh and delicious."
            }
          ...
          <Section
            ...
            desc={
              "we are constantly exploring new ways to reduce our carbon footprint. At our restaurant, we believe that food is not just nourishment for the body, but also for the soul. We are passionate about creating a dining experience that is not just about the food, but also about the memories that are made around the table.Thank you for considering our restaurant, and we look forward to welcoming you soon"
            }
          ...
          <Section
            title={"Careers"}
            desc={
              "We are passionate about creating a dining experience that is not just about the food, but also about the memories that are made around the table.Thank you for considering our restaurant, and we look forward to welcoming you soon"
            }
